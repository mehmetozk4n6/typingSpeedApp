  ...
  extraReducers: (builder) => {
    builder
        ...
        .addCase(getText.fulfilled,(state,action)=> {
          ...
          state.textGenerator = action.payload[0].split(" ");
        })
...
export const { incrementTextNum,addbool } = TypingSlice.actions;
...
export const selectTimer = (state: RootState) => state.typing.timer;
